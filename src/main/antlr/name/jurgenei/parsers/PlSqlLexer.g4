...
PERCENT_BULK_EXCEPTIONS        : '%' SPACE* B U L K '_' E X C E P T I O N S;
PERCENT_BULK_ROWCOUNT          : '%' SPACE* B U L K '_' R O W C O U N T;
...
//    '@' '@'?
// s; // https://docs.oracle.com/cd/B19306_01/server.102/b14357/ch12003.htm

START_CMD: {getCharPositionInLine() == 0}? [ \t]* '@' '@'? [ \t]* ~[ \t\r\n]+;
